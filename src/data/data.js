  ...
  profiles: {
    ...
    jarvi:{
      ...
      "about": {
        ...
        "body":"I’m a Product Owner with a developer background, and what excites me most is exactly where Jarvi seems to be heading: fewer layers between the user problem and the shipped solution. I like understanding a real pain point, challenging the initial request, designing something useful, and getting my hands dirty until it actually works — not just until it becomes a well-groomed ticket in Jira.\n\nMy path from fullstack developer to Product Owner taught me to live comfortably between product thinking and technical execution. I’ve built internal tools, dashboards, complex workflows, API integrations and data-driven features across demanding environments like health, aerospace and manufacturing. Those experiences shaped the way I work: clarify the problem, reduce unnecessary complexity, ship something reliable, then iterate based on feedback from the people who use it every day.\n\nWhat I find especially compelling at Jarvi is the Product Builder mindset. I don’t see AI as a magic wand, but as a serious leverage tool for people who already know how to reason about products, systems and users. I’ve always enjoyed prototyping, investigating issues, digging into data, understanding APIs and databases, and turning vague operational friction into concrete improvements. The idea of using AI to shorten the loop between discovery, building and delivery feels very natural to me — and honestly, much closer to the kind of product work I enjoy.\n\nI’m also drawn to the fact that Jarvi builds for recruiters, a profession where time, context and relationship quality matter a lot. A good ATS/CRM should not become another administrative layer; it should disappear into the workflow, remove repetitive effort, and help users focus on conversations, judgment and placement. That combination of automation, clarity and human impact is exactly the kind of product challenge that motivates me.\n\nAs a dad of two young kids, I’ve learned to value focus, autonomy and useful outcomes over noise. I’m calm under pressure, comfortable with responsibility, and allergic to building things just because they sounded good in a meeting. I’m looking for a small, ambitious team where I can contribute end-to-end, talk directly with users, build with modern tools, and leave visible fingerprints on the product. Jarvi feels like the right place to bring my product mindset, technical background and builder energy — with just enough geek curiosity to ask: ‘what if we could ship this today?’"
      }
    }
  },
  shop: [
